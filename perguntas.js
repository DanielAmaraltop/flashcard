criaCartao(
'Física',
'Como a simplificação de um objeto para um ponto material pode facilitar a análise de um problema de cinemática',
'Simplificar um objeto para um ponto material reduz a complexidade do problema permitindo focar apenas nas variáveis principais')
criaCartao(
'Física',
'explique como a análise de um corpo extenso difere da de um ponto material em um problema de cinemática',
'A análise de um corpo extenso considera as variáveis de rotação, torque e distribuição de massa além do movimento translacional')
criaCartao(
'Física',
'O que é uma partícula?',
'uma partícula é um objeto se dimensões desprezíveis, usado para simplificar problemas')
criaCartao(
'Física',
'O que caracteriza um corpo extenso?',
'Tem dimensões que não pode ser despresadas em análise de movimento, pois diferentes partes podem ter velocidades e acelerações distintas')
criaCartao(
'Física',
'O que é um movimento em cinemática',
'Quando um objeto muda sua posição em relação a um referencial ao longo do tempo')
criaCartao(
'Matemática',
